                ...
                <tr>
                  <td align="center">
                    <table align="center" border="0" cellpadding="0" cellspacing="0" width="480" style="border-collapse:collapse">
                      ...
                      <tr>
                        <td align="center" style="font-size:48px;line-height:60px;font-weight:600;color:#252525;">from <b style="font-size: 68px; color: #ED008C;">£${lowPrice}</b><img style="display:inline-block;" width="42" height="48" src="https://uploads-ssl.webflow.com/5f47b76ee28c574aee330915/5f7181cc0d482e0fdb2c7323_hero_arrow.png" alt="arrow"/></td>
                      </tr>
                      <tr>
                        <td align="center" style="background-color:#CFD1EF;padding:10px;"></td>
                      </tr>
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                            <table align="center" border="0" cellpadding="10" cellspacing="0" width="272" style="border-collapse:collapse;">
                                              ...
                                              <tr>
                                                <td style="font-size:15px;color:#252525;line-height:1;"><b style="font-weight:600;">Buying Price:</b> £${buyingPrice}</td>
                                              </tr>
                                              <tr>
                                                <td style="background-color:#EAEAF2;padding:1px;"></td>
                                              </tr>
                                              <tr>
                                                <td style="font-size: 15px;color: #252525;line-height: 1;"><b style="font-weight:600;">Property Type:</b> ${propertyType}</td>
                                              </tr>
                                            </table>
                                          </td>
                                        </tr>
